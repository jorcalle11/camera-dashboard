...
export default function TileOverlay({ camera, state = "stopped", onSnapshot, onHistory }: TileOverlayProps) {
  return (
      ...
      <div className="flex items-center gap-1.5">
        {onHistory && (
          <button
            ...
            className="pointer-events-auto cursor-pointer rounded bg-blue-600 px-2 py-1 text-xs font-medium hover:bg-blue-500"
